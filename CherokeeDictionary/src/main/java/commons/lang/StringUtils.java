 ...
 * another</li>
 * <li><b>IsAlpha/IsNumeric/isSpace/IsAsciiPrintable</b> - checks the
 ...
 * {@link Character#isSpace(char)}</li>
...
public class StringUtils {
	...
	// Whitespace:
	// Character.isSpace() is faster than WHITESPACE.indexOf()
	 ...
	 * defined by {@link Character#isSpace(char)}. Alternatively use
	 * {@link #strip(String)}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * If the stripChars String is <code>null</code>, whitespace is stripped as
	 * defined by {@link Character#isSpace(char)}.
	 * </p>
	 *
	 * <pre>
	...
	public static String stripStart(String str, String stripChars) {
		...
		if (stripChars == null) {
			while ((start != strLen)
					&& Character.isSpace(str.charAt(start))) {
				start++;
			}
	...
	public static String stripEnd(String str, String stripChars) {
		...
		if (stripChars == null) {
			while ((end != 0) && Character.isSpace(str.charAt(end - 1))) {
				end--;
			}
		} else if (stripChars.length() == 0) {
			return str;
	 ...
	 * in an array.
	 * </p>
	 * Whitespace is defined by {@link Character#isSpace(char)}.</p>
	 *
	 * <p>
	 * A new array is returned each time, except for length zero. A
	 * <code>null</code> array will return <code>null</code>. An empty array
	 ...
	 * separator. Whitespace is defined by {@link Character#isSpace(char)}.
	 * </p>
	 *
	 * <p>
	...
	private static String[] splitWorker(String str, String separatorChars,
		...
		// Also, StringTokenizer uses isSpace() not isSpace()
...
//	}
	 ...
	 *
	 * <p>
	 * Whitespace is defined by {@link Character#isSpace(char)}. A
	 * <code>null</code> input String returns <code>null</code>.
	 * </p>
	 *
	 * @param str
...
//	}
	 ...
	 *
	 * <pre>
	 * StringUtils.isSpace(null)   = false
	 * StringUtils.isSpace("")     = true
	 * StringUtils.isSpace("  ")   = true
	 * StringUtils.isSpace("abc")  = false
	 * StringUtils.isSpace("ab2c") = false
	 * StringUtils.isSpace("ab-c") = false
	 * </pre>
	 *
	 * @param str
	 *            the String to check, may be null
